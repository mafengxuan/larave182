 ...
 <body>
  <div class="mws-panel grid_8"> 
   <div class="mws-panel-header"> 
    <span><i class="icon-table"></i> 类型列表</span> 
   </div> 
     ...
     <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info"> 
      ...
      <tbody role="alert" aria-live="polite" aria-relevant="all">
       ...
       <tr> 
       		...
       		<td>
       			<a href="/admin/type/delete/{{ $v['id'] }}" title="删除" style="color:#000;font-size:20px;margin-right:15px;"><i class="icon-trash"></i></a>
       			<a href="/admin/type/edit/{{ $v['id'] }}" title="修改" style="color:#000;font-size:20px;margin-right:15px;"><i class="icon-pencil-2"></i></a>
       		</td>
       </tr>
       @endforeach
      </tbody>
